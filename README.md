...
$url = "https://raw.githubusercontent.com/okamuroshogo/windows-first-setup/main/scripts/00-bootstrap-openssh.ps1"
$script = Invoke-RestMethod -Uri $url
# 内容を確認
$script
# 確認後にファイルに保存して実行
$outPath = "$env:TEMP\00-bootstrap-openssh.ps1"
[System.IO.File]::WriteAllText($outPath, $script, (New-Object System.Text.UTF8Encoding $false))
...
```powershell
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; irm "https://raw.githubusercontent.com/okamuroshogo/windows-first-setup/main/scripts/00-bootstrap-openssh.ps1" | iex
```
